...
| 最新已验证提交 | `b974d10`（粒子方向标记）；其后 `444099b`（云按 pan 着色，预期 623）与两个文档提交在推 |
| 最近全绿 CI | Run `#35355098143`（`b974d10`）：Build **0 条 error**、**622 用例 / 0 失败 / 342995 断言**、pluginval `Strictness level: 5` **SUCCESS**、forensics **0 CRASH-OR-FAIL**（7 SKIP-UNMATCHED = 名字来自未编入 exe 的源文件） |
| 本轮批次链（每步全绿） | `c335326` 帧混合曲线 #35316399784 = 613 · `db20abf` 枚举真菜单 #35318939971 = 616 · `81e4138` 颗粒池优化 #35319079605 = 617 · `bcde027` 文档/工具 #35321642036 = 617 · `05e881d` 粒子云 #35352187933 = 618 · `cecf136` GRAIN 页 MIDI Learn #35352359490 = 618 · `bd188b3` 采样包络条 #35354233013 = 619 · `c070428` SPREAD/REVERSE #35354598393 = 621 · `b974d10` 粒子方向 #35355098143 = 622 |
| 更早的全绿 | `a6e5f3b` #35315329172 = 611（谐波分箱 + 颗粒层 + MIDI Learn）、`578253a` #35311445334（颗粒层首批）、`6d82383` #35310048933（P6b/主题） |
| 用例计数 | 源码内 **628 个 `TEST_CASE` 名**、**622 个实际执行**；`444099b` 后应为 629 / 623（数字全部来自 runner 注解，见 §1） |
| 未验证批次 | `444099b` 云按 pan 着色（预期 **623 用例**） |
