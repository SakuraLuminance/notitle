...
> ⚠️ CI 的 `Test` 步骤带 `continue-on-error: true`：**测试失败 run 依然是绿的**，必须读日志里的 `All tests passed (… in N test cases)` 与 `Strictness level`。
...
| `docs/superpowers/plans/2026-09-07-p2-p6-roadmap.md` | 里程碑总表（P1–P6 + P6b 已完成） |
